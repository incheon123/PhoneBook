...
constexpr auto qt_meta_stringdata_CLASSPhoneBookENDCLASS = QtMocHelpers::stringData(
    "PhoneBook",
    "click_back",
    "",
    "p",
    "on_signin_clicked",
    "on_signup_clicked",
    "on_forgetAccount_clicked",
    "on_signup_user_id_dp_chk_btn_clicked",
    "on_signup_submit_btn_clicked",
    "on_submit_clicked",
    "on_find_account_back_btn_clicked",
    "on_signup_back_btn_clicked"
);
...
Q_CONSTINIT const QMetaObject PhoneBook::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPhoneBookENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_forgetAccount_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_signup_user_id_dp_chk_btn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_signup_submit_btn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_submit_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_find_account_back_btn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_signup_back_btn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void PhoneBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->click_back((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->on_signin_clicked(); break;
        case 2: _t->on_signup_clicked(); break;
        case 3: _t->on_forgetAccount_clicked(); break;
        case 4: _t->on_signup_user_id_dp_chk_btn_clicked(); break;
        case 5: _t->on_signup_submit_btn_clicked(); break;
        case 6: _t->on_submit_clicked(); break;
        case 7: _t->on_find_account_back_btn_clicked(); break;
        case 8: _t->on_signup_back_btn_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PhoneBook::*)(int );
            if (_t _q_method = &PhoneBook::click_back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PhoneBook::click_back(int _t1)
{

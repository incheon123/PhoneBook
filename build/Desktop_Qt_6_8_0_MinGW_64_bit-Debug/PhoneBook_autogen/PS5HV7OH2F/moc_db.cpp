...
struct qt_meta_stringdata_CLASSDbENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDbENDCLASS = QtMocHelpers::stringData(
    "Db"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDbENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Db::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDbENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDbENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDbENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Db::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDbENDCLASS.stringdata0))
